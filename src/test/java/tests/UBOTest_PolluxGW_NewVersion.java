...
public class UBOTest_PolluxGW_NewVersion extends TestBase{
    ...
    @Test(priority=4, description="Open File Master application in ADMIN MODE")
    ...
    @Test(priority=5, description="Opens RFAS and checks the Client Authorization with OLD Pollux version")
    ...
    @Test(priority=6, description="Renaming PolluxFromPanelTPI folder")
    ...
    @Test(priority=10, description="Sending Jobs to FileMaster with New Pollux Version",timeOut = 600000)  //10 mins timeout
    ...
    @Test(priority=13, description="Opening Signals Admin and Priority List Action executed with NEW Publisher versionn")
    ...
    @Test(priority=14, description="Moves the old PolluxGW version from UNITAM SW folder to other folder")  //
